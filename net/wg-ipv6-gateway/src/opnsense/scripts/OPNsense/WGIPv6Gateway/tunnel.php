 ...
 * 6.4): list|status|reconcile|create|remove|rebind|adopt|ensure-sentinel|
 * measure-mtu|apply [--dry] [--json], and --selftest. See lib/cli.php. The
...
exit(wgipv6_cli_main(array_slice($argv ?? [], 1)));
